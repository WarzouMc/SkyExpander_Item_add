...
public class Shard2 implements Items {
    ...
    public ItemStack build() {
        ...
        itemMeta.setDisplayName("§2§lShard §5§oLvl 2");
        itemMeta.setLore(Arrays.asList("§5###########", "§2Utilisable pour :", "§2-Shard level 3", "§2-SuperIron", "§5###########", "§4§lCette item est utilisable", "§4§lcomme n'importe quel item :", "§4§l-craft", "§4§l-comburant", "§4§l...", "§5###########"));
    ...
    public ItemStack a() {
        ...
        return getNewItems.SUPERCOAL.build();
    }
